...
const Logo = () => (
    <svg width="140" height="40" viewBox="0 0 160 50" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-accent">
        ...
        <text x="58" y="45" fontFamily="Alegreya, serif" fontSize="16" fill="currentColor">ASCHER</text>
